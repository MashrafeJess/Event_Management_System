...
public class CartService
{
    ...
    {
        bool alreadyExists = context.Cart.Any(x => x.OfferId == cart.OfferId && x.EventDate==cart.EventDate);
        if (alreadyExists)
        {
    ...
    public Result JoinCartList()
    {
       var cartList = context.JoinCart.ToList();
        return new Result(true, "All the carts are shown", cartList);
    }
}
